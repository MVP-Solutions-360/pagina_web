...
// Reemplaza config.js en producción
...
const PROJECT_CONFIG = {
    ...
    api: {
        // IMPORTANTE: Cambiar esta URL por tu dominio real
        baseURL: 'https://tudominio.com/crm/api/v1', // URL de producción
        timeout: 30000,
        retryAttempts: 3,
        agencySlug: 'agencia-principal',
        endpoints: {
            agency: '/agency',
